        ...
        <div class="screen">
            <div class="screen__content">
                <form class="login" @submit.prevent="Register">
                    ...
                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" class="login__input" placeholder="Confirm Password" v-model="conf_password">
                    </div>
                    ...
                    <footer>
                        <p class="footer__text">Already have an account? <router-link to="/login" class="footer__link">
                                Sign in</router-link>
                        </p>
                    </footer>
                </form>
